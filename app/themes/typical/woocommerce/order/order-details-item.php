...
?>
<div class="in-row <?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'woocommerce-table__line-item order_item', $item, $order ) ); ?>">

	<div class="woocommerce-table__product-name product-name bc">
		<?php
	...
	<div class="woocommerce-table__product-total product-total bc">
